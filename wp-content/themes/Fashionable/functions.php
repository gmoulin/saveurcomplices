<?php
    ...
    $theme->admin_option('Support',
        ...
        <li><strong>Theme Homepage:</strong> <a href="http://fthemes.com/fashionable-free-wordpress-theme" target="_blank">http://fthemes.com/fashionable-free-wordpress-theme/</a></li>
    ...
    {
        global $theme;
        $theme->display_widget('Facebook', array('url'=> 'http://www.facebook.com/FThemes', 'colorscheme' => 'dark', 'width'=> '260', 'title' => ''));
